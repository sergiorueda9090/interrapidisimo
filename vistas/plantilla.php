...
<head>
  ...
  <title>Interrapidisimo</title>

  <!-- Tell the browser to be responsive to screen width -->
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">

  <link rel="icon" href="vistas/img/plantilla/bolitoo.png">
 ...
 <!-- Morris chart -->
  ...
  <!-- select2 -->
   <link rel="stylesheet" href="vistas/plugins/select/select2.css">
  ...
  <!-- select2 -->
  <script src="vistas/plugins/select/select2.js"></script>
...
<!-- InputMask -->
  ...
  <!--JQUERY NUMBER-->
<!--<script src="vistas/plugins/jqueryNumber/jquerynumber.min.js" type="text/javascript"></script>-->
